...
export const DEFENSE_TYPES = {
  SOLAR_PANEL: {
    id: 'SOLAR_PANEL',
    name: 'Solar Panel',
    description: 'Generates KW to power defenses. Upgraded panels divert energy to heal the station.',
    color: 0x2255cc,
    panelColor: 0x1a3d8f,
    category: 'energy',
    levels: [
      { cost: 40,  health: 80,  damage: 0, range: 0, attackCooldown: 0, kwPerSecond: 3,  healPerSecond: 0 },
      { cost: 60,  health: 120, damage: 0, range: 0, attackCooldown: 0, kwPerSecond: 5,  healPerSecond: 2 },
      { cost: 100, health: 160, damage: 0, range: 0, attackCooldown: 0, kwPerSecond: 8,  healPerSecond: 5 },
    ],
  },
  WIND_TURBINE: {
    id: 'WIND_TURBINE',
    name: 'Wind Turbine',
    description: 'High KW output to power defenses.',
    color: 0xdddddd,
    panelColor: 0xeeeeee,
    category: 'energy',
    levels: [
      { cost: 80,  health: 120, damage: 0, range: 0, attackCooldown: 0, kwPerSecond: 6,  healPerSecond: 0 },
      { cost: 120, health: 180, damage: 0, range: 0, attackCooldown: 0, kwPerSecond: 10, healPerSecond: 0 },
      { cost: 180, health: 250, damage: 0, range: 0, attackCooldown: 0, kwPerSecond: 15, healPerSecond: 0 },
    ],
  },
  TURRET: {
    id: 'TURRET',
